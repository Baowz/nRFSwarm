...
#define MOTOR_OFFSET_RIGHT 0.9f
...
#define KD_OBSTACLE_FIELD_ONE 0.0f
#define KI_OBSTACLE_FIELD_ONE 27.0f
...
#define KD_OBSTACLE_FIELD_THREE 0.0f
#define KI_OBSTACLE_FIELD_THREE 30.0f
...
#define MINIMUM_SIGNAL_STRENGTH   -65.0f // abs(dBM)
#define MAXIMUM_SIGNAL_STRENGTH   -60.0f // abs(dBM)
