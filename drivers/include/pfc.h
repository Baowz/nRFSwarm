...
#define KD_OBSTACLE_FIELD_ONE 5.0f
#define KI_OBSTACLE_FIELD_ONE 0.0f

#define KP_OBSTACLE_FIELD_TWO 40.0f
#define KD_OBSTACLE_FIELD_TWO 5.0f
#define KI_OBSTACLE_FIELD_TWO 0.0f

#define KP_OBSTACLE_FIELD_THREE 135.0f
#define KD_OBSTACLE_FIELD_THREE 5.0f
#define KI_OBSTACLE_FIELD_THREE 0.0f

#define KP_OBSTACLE_FIELD_FOUR 40.0f
#define KD_OBSTACLE_FIELD_FOUR 5.0f
...
#define OBSTACLE_CUTOFF_DISTANCE  150.0f
