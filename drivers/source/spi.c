...
static const nrf_drv_spi_t spi_shield  = NRF_DRV_SPI_INSTANCE(2);
...
void spi_init(void)
{
  ...
  nrf_drv_spi_config_t shield_config = {
  ...
  err_code = nrf_drv_spi_init(&spi_shield, &shield_config, NULL, NULL);
  APP_ERROR_CHECK(err_code);
