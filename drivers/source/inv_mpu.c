...
#define i2c_write(a, b, c, d)   twi_write(a, b, c, d)
#define i2c_read(a, b, c, d)    twi_read(a, b, c, d)
#define delay_ms                nrf_delay_ms
#define get_ms                  app_mpu_get_ms
...
/*
#ifdef AK89xx_SECONDARY
    setup_compass(); //TODO: This function asserts. Fix this in order to use the compass.
...
#ifdef AK89xx_SECONDARY
/* TO DO: Fix this in order to use magnetometer. */
