...
{
    change_duty_cycle(_r, _g, _b, &status_led, &seq_values);
}
...
{
    _status_led->duty_cycle_r = DUTY_CYCLE_CONVERSION(_duty_cycle_r, STATUS_LED_PWM_TOP_VALUE);
    _status_led->duty_cycle_g = DUTY_CYCLE_CONVERSION(_duty_cycle_g, STATUS_LED_PWM_TOP_VALUE);
    _status_led->duty_cycle_b = DUTY_CYCLE_CONVERSION(_duty_cycle_b, STATUS_LED_PWM_TOP_VALUE);

    update_duty_cycle(&_status_led, &_seq_values);
}

void update_duty_cycle(status_led_t *_status_led, nrf_pwm_values_individual_t *_seq_values)
{
