	...
	.eabi_attribute 34, 1
	.eabi_attribute 18, 4
	.file	"ascii_converter.c"
	.text
.Ltext0:
	.global	hex_to_ascii_number_table
	.section	.data.hex_to_ascii_number_table,"aw",%progbits
	.align	2
	.type	hex_to_ascii_number_table, %object
	.size	hex_to_ascii_number_table, 16
hex_to_ascii_number_table:
	.byte	48
	.byte	49
	.byte	49
	.byte	51
	...
	.byte	69
	.byte	70
	.section	.text.hex_array_to_ascii,"ax",%progbits
	.align	1
	.global	hex_array_to_ascii
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	hex_array_to_ascii, %function
hex_array_to_ascii:
.LFB0:
	.file 1 "C:\\Repositories\\nRFSwarm\\drivers\\source\\ascii_converter.c"
	.loc 1 12 0
...
.L5:
	.word	size.5126
	.word	hex_to_ascii_number_table
.LFE0:
	.size	hex_array_to_ascii, .-hex_array_to_ascii
	.section	.bss.size.5126,"aw",%nobits
	.align	1
	.type	size.5126, %object
	.size	size.5126, 2
size.5126:
	.space	2
...
.Letext0:
	...
	.file 3 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 3.34/include/__crossworks.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	hex_to_ascii_number_table
	.uleb128 0x16
	.4byte	.LASF563
	.byte	0x1
	.byte	0xb
...
.Ldebug_abbrev0:
	...
	.4byte	0x612
	.4byte	0x59d
	.ascii	"hex_to_ascii_number_table\000"
	.4byte	0x5ae
	.ascii	"hex_array_to_ascii\000"
	.4byte	0
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro5
	.byte	0x4
	.file 6 "../../../drivers/include/ascii_converter.h"
	.byte	0x3
	.uleb128 0x5
	.uleb128 0x6
	.byte	0x4
...
.LASF560:
	.ascii	"C:\\Repositories\\nRFSwarm\\drivers\\source\\ascii_"
	.ascii	"converter.c\000"
.LASF198:
